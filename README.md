...
| [@napplet/build-tools](packages/build-tools) | — | — | Shared build-time signer, verified NIP-65/BUD-03 Blossom discovery, exact-byte upload, and endpoint-policy helpers used by the Vite optimizer; this implementation plumbing does not add protocol surface. |
