// @napplet/shim -- Keys NUB shim (keyboard forwarding + action keybindings)
// Replaces the old keyboard-shim.ts with full NUB-KEYS smart forwarding,
// suppress list, action handlers, and shell-push binding updates.
