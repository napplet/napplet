...
<!-- v0.30.0 PLACEHOLDER (originally written as v0.29.0 on main branch; to be split out to v0.30.0 in a follow-up) -->
## Shipped: v0.30.0 Class-Gated Decrypt Surface (PRE-MIGRATION)
...
No active milestone. v0.29.0 NUB-CONNECT + Shell as CSP Authority shipped 2026-04-21; v0.30.0 Class-Gated Decrypt Surface (pre-migration placeholder; originally shipped as v0.29.0 on main, 2026-04-23) ships once the version split is finalized. Run `/gsd:new-milestone` to define the next milestone.
...
---
*Last updated: 2026-04-23 — merged v0.29.0 NUB-CONNECT + Shell as CSP Authority (feat/strict-model, 2026-04-21) with v0.30.0 Class-Gated Decrypt Surface placeholder (originally written as v0.29.0 on main, 2026-04-23). Version split pending.*
