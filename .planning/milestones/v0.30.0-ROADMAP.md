# Roadmap: v0.30.0 — Class-Gated Decrypt Surface

> Originally written and self-labeled as v0.29.0 on the napplet main branch (shipped 2026-04-23). Renumbered to v0.30.0 during the post-merge version-split. Phase numbers 135-138 inside this roadmap are preserved as originally authored to keep commit-message references valid; they collide numerically with v0.29.0 phases of the same numbers, but the directories are scoped under .planning/milestones/v0.30.0-phases/.

---

- ✅ **v0.28.0 Browser-Enforced Resource Isolation** — Phases 125-134 (shipped 2026-04-23) — [Archive](milestones/v0.28.0-ROADMAP.md)
- 🚧 **v0.30.0 Class-Gated Decrypt Surface** — Phases 135-138 (in progress)
...
### 🚧 v0.30.0 Class-Gated Decrypt Surface (In Progress)
