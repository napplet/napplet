...
- [x] **DOC-01**: `@napplet/nub-keys` README with message reference
- [x] **DOC-02**: Update NIP-5D NUB domain table to include `keys`
- [x] **DOC-03**: Update core, shim, and SDK READMEs for keys NUB
...
| DOC-01 | Phase 92 | Complete |
| DOC-02 | Phase 92 | Complete |
| DOC-03 | Phase 92 | Complete |
