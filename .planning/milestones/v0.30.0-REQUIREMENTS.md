# Requirements: v0.30.0 — Class-Gated Decrypt Surface

> Originally written and self-labeled as v0.29.0 on the napplet main branch (shipped 2026-04-23). Renumbered to v0.30.0 during the post-merge version-split.

---

# Requirements Archive: v0.30.0 Class-Gated Decrypt Surface
...
# Requirements: Napplet Protocol SDK — v0.30.0 Class-Gated Decrypt Surface
