# v0.30.0 PRE-MIGRATION PLACEHOLDER — extracted from .planning/milestones/v0.29.0-REQUIREMENTS.md merge conflicts
...
# Requirements Archive: v0.29.0 Class-Gated Decrypt Surface
