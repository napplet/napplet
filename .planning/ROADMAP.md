...
- [ ] 114-01-PLAN.md — configSchema option + 3-path discovery (inline / config.schema.json / napplet.config.*) + configResolved hook (VITE-01..03)
- [ ] 114-02-PLAN.md — validateConfigSchema structural guard (root-type, pattern, external $ref, secret-with-default) + configResolved integration (VITE-07)
...
| 114. Vite-Plugin Extension | 0/3 | Planned     | - |
