...
stopped_at: "Milestone v0.26.0 started — defining requirements"
...
Last activity: 2026-04-19 — Milestone v0.26.0 Better Packages started
...
Stopped at: Milestone v0.26.0 Better Packages started. Requirements gathering next.
Resume: Run `/gsd:new-milestone` workflow (continuing) to define REQUIREMENTS.md and ROADMAP.md.
